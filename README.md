...
![konyai](https://github.com/user-attachments/assets/9ba5f6c8-a3b0-490a-babe-a5f8cd4e77b5)
...
### **Özet Tablo**
| Model Türü         | Örnek Modeller                   | Kullanım Alanları                              |
|---------------------|----------------------------------|-----------------------------------------------|
| Encoder-Only        | BERT, RoBERTa, DistilBERT       | Sınıflandırma, özetleme, bilgi çıkarımı       |
| Decoder-Only        | GPT, DialoGPT, OPT              | Metin üretimi, diyalog sistemleri             |
| Encoder-Decoder     | T5, BART, MarianMT, PEGASUS     | Çeviri, özetleme, soru yanıtlama             |
| Çok Modlu           | CLIP, DALL·E, FLAVA             | Görsel + metin işleme                         |
| Özel Modeller       | XLM-R, BigBird, Longformer      | Çapraz dilli görevler, uzun metin işlemleri   |
